...
namespace OverworldCore\CPT\Shortcodes\TopReviewsCarousel;

use OverworldCore\Lib\ShortcodeInterface;

class TopReviewsCarousel implements ShortcodeInterface {
	private $base;
	
	public function __construct() {
		$this->base = 'overworld_core_top_reviews_carousel';
	...
	public function vcMap() {
		$criteria_ratings = overworld_core_rating_criteria_for_vc();
		
		vc_map(
			array(
				'name'                      => esc_html__( 'Top Reviews Carousel', 'overworld-core' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					...
					array(
						...
						'heading'     => esc_html__( 'Number of Reviews', 'overworld-core' ),
						'description' => esc_html__( 'Leave empty for all', 'overworld-core' )
					),
					array(
						'type'        => 'dropdown',
						'param_name'  => 'review_criteria',
						'heading'     => esc_html__( 'Order by Review Criteria', 'overworld-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		return overworld_core_get_module_shortcode_template_part( 'reviews', 'top-reviews-carousel', 'top-reviews-carousel', '', $params );
	}
