<?php if ( is_array( $post_ratings ) && count( $post_ratings ) ) { ?>
	<?php $average_rating_total = overworld_core_get_total_average_rating( $post_ratings ); ?>
				...
				<div class="edgtf-grid-col-3">
					<div class="edgtf-item-reviews-average-wrapper">
						<div class="edgtf-item-reviews-average-rating">
							<?php echo esc_html( overworld_core_reviews_format_rating_output( $average_rating_total ) ); ?>
						</div>
						<div class="edgtf-item-reviews-verbal-description">
                            <span class="edgtf-item-reviews-rating-icon">
                                <?php echo overworld_core_reviews_get_icon_for_rating( $average_rating_total ); ?>
                            </span>
							<span class="edgtf-item-reviews-rating-description">
                                <?php echo esc_html( overworld_core_reviews_get_description_for_rating( $average_rating_total ) ); ?>
                            </span>
						</div>
					</div>
				</div>
				<div class="edgtf-grid-col-9">
					<div class="edgtf-rating-percentage-wrapper">
						...
						foreach ( $post_ratings as $rating ) {
							$percentage = overworld_core_post_average_rating_per_criteria( $rating );
