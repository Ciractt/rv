...
namespace OverworldCore\CPT;

use OverworldCore\Lib;

/**
 * Class PostTypesLoader
 * @package OverworldCore\CPT
 */
class PostTypesRegister {
	...
	private function addPostTypes() {
		$cpt_class_name = apply_filters( 'overworld_core_filter_register_custom_post_types', $cpt_class_name = array() );
