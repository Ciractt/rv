...
if (have_posts()) : while (have_posts()) : the_post(); ?>
	<?php if(post_password_required()) {
		...
		<div class="edgtf-tournament-single-holder">
			<?php overworld_core_get_cpt_single_module_template_part('templates/single/parts/top', 'tournament', '', $params); ?>
				...
				<div class="edgtf-grid-row <?php echo esc_attr( $edgtf_holder_classes ); ?>">
					<div <?php echo overworld_edge_get_content_sidebar_class(); ?>>
						<div class="edgtf-tournament-single-outer">
							<?php overworld_core_get_cpt_single_module_template_part('templates/single/parts/info', 'tournament', '', $params); ?>
							<?php overworld_core_get_cpt_single_module_template_part('templates/single/parts/content', 'tournament', '', $params); ?>
							<?php overworld_core_get_cpt_single_module_template_part('templates/single/parts/comments', 'tournament'); ?>
						</div>
					</div>
