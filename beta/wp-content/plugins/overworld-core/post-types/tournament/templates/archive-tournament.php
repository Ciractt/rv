...
<div class="edgtf-container edgtf-default-page-template">
	...
	<div class="edgtf-container-inner clearfix">
		<?php
			...
			$overworld_taxonomy = !empty($overworld_taxonomy_id) ? get_term_by( 'id', $overworld_taxonomy_id, 'tournament-category' ) : '';
			$overworld_taxonomy_slug = !empty($overworld_taxonomy) ? $overworld_taxonomy->slug : '';

			overworld_core_get_tournament_category_list($overworld_taxonomy_slug);
		?>
	</div>
