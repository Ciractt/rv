<?php
if ( ! function_exists( 'overworld_edge_init_google_fonts_array' ) ) {
    function overworld_edge_init_google_fonts_array() {
...
';
        ...
        $overworld_edge_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'overworld_edge_init_google_fonts_array');
}