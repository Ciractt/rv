<?php
namespace OverworldCore\CPT\Shortcodes\ClientsCarousel;
...
class ClientsCarousel implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Clients Carousel', 'overworld-core' ),
					'base'            => $this->getBase(),
					...
					'params'          => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Items Hover Animation', 'overworld-core' ),
							'value'       => array(
								esc_html__( 'Switch Images', 'overworld-core' ) => 'switch-images',
								esc_html__( 'Roll Over', 'overworld-core' )     => 'roll-over'
							),
							'save_always' => true
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = overworld_core_get_shortcode_module_template_part( 'templates/clients-carousel', 'clients-carousel', '', $params );
