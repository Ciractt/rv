<?php
namespace OverworldCore\CPT\Shortcodes\ElementsHolder;
...
class ElementsHolder implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Elements Holder', 'overworld-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Holder Full Height', 'overworld-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Columns', 'overworld-core' ),
							'value'       => array(
								esc_html__( '1 Column', 'overworld-core' )  => 'one-column',
								esc_html__( '2 Columns', 'overworld-core' ) => 'two-columns',
								esc_html__( '3 Columns', 'overworld-core' ) => 'three-columns',
								esc_html__( '4 Columns', 'overworld-core' ) => 'four-columns',
								esc_html__( '5 Columns', 'overworld-core' ) => 'five-columns',
								esc_html__( '6 Columns', 'overworld-core' ) => 'six-columns'
							),
							'save_always' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Items Float Left', 'overworld-core' ),
							'value'      => array( 'Make Items Float Left?' => 'yes' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'switch_to_one_column',
							'heading'     => esc_html__( 'Switch to One Column', 'overworld-core' ),
							'value'       => array(
								esc_html__( 'Default', 'overworld-core' )      => '',
								esc_html__( 'Below 1366px', 'overworld-core' ) => '1366',
								esc_html__( 'Below 1024px', 'overworld-core' ) => '1024',
								esc_html__( 'Below 768px', 'overworld-core' )  => '768',
								esc_html__( 'Below 680px', 'overworld-core' )  => '680',
								esc_html__( 'Below 480px', 'overworld-core' )  => '480',
								esc_html__( 'Never', 'overworld-core' )        => 'never'
							),
							'description' => esc_html__( 'Choose on which stage item will be in one column', 'overworld-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'alignment_one_column',
							'heading'     => esc_html__( 'Choose Alignment In Responsive Mode', 'overworld-core' ),
							'value'       => array(
								esc_html__( 'Default', 'overworld-core' ) => '',
							...
							'description' => esc_html__( 'Alignment When Items are in One Column', 'overworld-core' ),
							'save_always' => true
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = '<div ' . overworld_edge_get_class_attribute( $holder_classes ) . ' ' . overworld_edge_get_inline_attr( $holder_styles, 'style' ) . '>';
