...
class ElementsHolderItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Elements Holder Item', 'overworld-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Padding', 'overworld-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'overworld-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'horizontal_alignment',
							'heading'    => esc_html__( 'Horizontal Alignment', 'overworld-core' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Vertical Alignment', 'overworld-core' ),
							'value'      => array(
								esc_html__( 'Middle', 'overworld-core' ) => 'middle',
								esc_html__( 'Top', 'overworld-core' )    => 'top',
								esc_html__( 'Bottom', 'overworld-core' ) => 'bottom'
							)
						),
						array(
							'type'       => 'dropdown',
							...
							'value'      => array(
								esc_html__( 'Default (No Animation)', 'overworld-core' )   => '',
						...
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 1400px-1600px', 'overworld-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. For example 10px 0 10px 0', 'overworld-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'overworld-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'item_padding_1025_1399',
							'heading'     => esc_html__( 'Padding on screen size between 1025px-1399px', 'overworld-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. For example 10px 0 10px 0', 'overworld-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'overworld-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 768px-1024px', 'overworld-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'overworld-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'overworld-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 680px-768px', 'overworld-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'overworld-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'overworld-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size bellow 680px', 'overworld-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'overworld-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'overworld-core' )
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = overworld_core_get_shortcode_module_template_part( 'templates/elements-holder-item-template', 'elements-holder', '', $params );
