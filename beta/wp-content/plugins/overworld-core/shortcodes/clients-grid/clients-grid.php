<?php
namespace OverworldCore\CPT\Shortcodes\ClientsGrid;
...
class ClientsGrid implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if(function_exists('vc_map')) {
			vc_map(
				array(
					'name'      => esc_html__( 'Clients Grid', 'overworld-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Items Horizontal Alignment', 'overworld-core' ),
							'value'       => array(
								esc_html__( 'Default Center', 'overworld-core' ) => '',
	...
	public function render( $atts, $content = null ) {
		...
		$html = overworld_core_get_shortcode_module_template_part( 'templates/clients-grid', 'clients-grid', '', $params );
