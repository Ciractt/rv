<?php
namespace OverworldCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Call To Action', 'overworld-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Set Content In Grid', 'overworld-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Elements Proportion', 'overworld-core' ),
							'value'      => array(
								esc_html__( '80/20', 'overworld-core' ) => '80',
								esc_html__( '75/25', 'overworld-core' ) => '75',
								esc_html__( '66/33', 'overworld-core' ) => '66',
								esc_html__( '50/50', 'overworld-core' ) => '50'
							),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'normal' ) )
						),
						array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Background Color', 'overworld-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Hover Background Color', 'overworld-core' ),
							'group'      => esc_html__( 'Button Style', 'overworld-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_border_color',
							'heading'    => esc_html__( 'Button Border Color', 'overworld-core' ),
							'group'      => esc_html__( 'Button Style', 'overworld-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_border_color',
							'heading'    => esc_html__( 'Button Hover Border Color', 'overworld-core' ),
							'group'      => esc_html__( 'Button Style', 'overworld-core' )
						),
						array(
							'type'       => 'textarea_html',
							'param_name' => 'content',
							'heading'    => esc_html__( 'Content', 'overworld-core' ),
							'value'      => esc_html__( 'I am test text for Call to Action shortcode content', 'overworld-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = overworld_core_get_shortcode_module_template_part( 'templates/call-to-action', 'call-to-action', '', $params );
	...
	private function getButtonHolderStyles( $params ) {
		...
		if ( ! empty( $params['button_top_margin'] ) && $params['layout'] === 'simple' ) {
			$styles[] = 'margin-top: ' . overworld_edge_filter_px( $params['button_top_margin'] ) . 'px';
		}
