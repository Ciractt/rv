...
if ( ! function_exists( 'overworld_edge_get_hide_dep_for_header_main_menu_options' ) ) {
	function overworld_edge_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'overworld_edge_filter_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'overworld_edge_header_main_navigation_options_map' ) ) {
	function overworld_edge_header_main_navigation_options_map() {
		$hide_dep_options = overworld_edge_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = overworld_edge_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'overworld' ),
		...
		overworld_edge_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'overworld' )
			)
		);
		...
		$drop_down_group = overworld_edge_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'overworld' )
			)
		);
		
		$drop_down_row1 = overworld_edge_add_admin_row(
			array(
        ...
        overworld_edge_add_admin_field(
            array(
                ...
                'default_value' => 'no',
                'label'         => esc_html__( 'Wide Dropdown Menu In Grid', 'overworld' ),
                'description'   => esc_html__( 'Set wide dropdown menu to be in grid', 'overworld' ),
            )
        );

        $wide_dropdown_menu_in_grid_container = overworld_edge_add_admin_container(
            array(
                'parent'          => $panel_main_menu,
        ...
        overworld_edge_add_admin_field(
            array(
                ...
                'default_value' => 'yes',
                'label'         => esc_html__( 'Wide Dropdown Menu Content In Grid', 'overworld' ),
                'description'   => esc_html__( 'Set wide dropdown menu content to be in grid', 'overworld' )
            )
        );
		...
		overworld_edge_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'overworld' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'overworld' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'overworld' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'overworld' )
				)
			)
		);
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dropdown Position', 'overworld' ),
				'description'   => esc_html__( 'Enter value in percentage of entire header height', 'overworld' ),
				'args'          => array(
					'col_width' => 3,
					'suffix'    => '%'
				)
		...
		$first_level_group = overworld_edge_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'overworld' )
			)
		);
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'overworld' ),
			)
		);
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'overworld' ),
			)
		);
		
		$first_level_row4 = overworld_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'overworld' ),
			)
		);
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'overworld' ),
			)
		);
		
		$first_level_row5 = overworld_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = overworld_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = overworld_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'overworld' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'overworld' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = overworld_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'overworld' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'overworld' )
			)
		);
		...
		$second_level_wide_group = overworld_edge_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'overworld' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'overworld' )
			)
		);
		
		$second_level_wide_row1 = overworld_edge_add_admin_row(
			array(
		...
		$second_level_wide_row2 = overworld_edge_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = overworld_edge_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = overworld_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'overworld' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'overworld' )
			)
		);
		...
		$third_level_wide_group = overworld_edge_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'overworld' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'overworld' )
			)
		);
		
		$third_level_wide_row1 = overworld_edge_add_admin_row(
			array(
		...
		$third_level_wide_row2 = overworld_edge_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = overworld_edge_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'overworld_edge_action_header_main_navigation_options_map', 'overworld_edge_header_main_navigation_options_map', 10, 1 );
}