...
if ( ! function_exists( 'overworld_edge_get_hide_dep_for_header_menu_area_options' ) ) {
	function overworld_edge_get_hide_dep_for_header_menu_area_options() {
		$hide_dep_options = apply_filters( 'overworld_edge_filter_header_menu_area_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'overworld_edge_header_menu_area_options_map' ) ) {
	function overworld_edge_header_menu_area_options_map( $panel_header ) {
		$hide_dep_options = overworld_edge_get_hide_dep_for_header_menu_area_options();
		...
		overworld_edge_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set grid background transparency for menu area', 'overworld' ),
				'args'          => array(
					'col_width' => 3
				)
			)
		...
		overworld_edge_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set shadow on grid area', 'overworld' )
			)
		);
		...
		overworld_edge_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set border color for menu area', 'overworld' ),
			)
		);
		...
		overworld_edge_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set background color for menu area', 'overworld' )
			)
		);
		...
		overworld_edge_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set background transparency for menu area', 'overworld' ),
				'args'          => array(
					'col_width' => 3
				)
			)
		...
		$menu_area_border_container = overworld_edge_add_admin_container(
			array(
				'parent'          => $menu_area_container,
		...
		do_action( 'overworld_edge_header_menu_area_additional_options', $panel_header );
	}
	
	add_action( 'overworld_edge_action_header_menu_area_options_map', 'overworld_edge_header_menu_area_options_map', 10, 1 );
}