...
<header class="edgtf-page-header">
			...
			<div class="edgtf-vertical-align-containers">
				...
				<div class="edgtf-position-right"><!--
				 --><div class="edgtf-position-right-inner">
						<a href="javascript:void(0)" <?php overworld_edge_class_attribute( $fullscreen_menu_icon_class ); ?>>
							<span class="edgtf-fullscreen-menu-opener-icon">
                                <?php echo overworld_edge_get_icon_sources_html( 'fullscreen_menu' ); ?>
							</span>
						</a>
					</div>
				</div>
	...
	<?php if($show_sticky) {
		overworld_edge_get_sticky_header('minimal', 'header/types/header-minimal');
	} ?>
