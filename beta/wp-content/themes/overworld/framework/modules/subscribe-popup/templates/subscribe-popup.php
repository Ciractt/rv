        ...
        <div class="edgtf-sp-table-cell">
            <div class="edgtf-sp-inner">
	            ...
	            <?php if ( ! empty( $background_styles ) ) { ?>
		            <div class="edgtf-sp-background" <?php overworld_edge_inline_style( $background_styles ); ?>></div>
	            <?php } ?>
	                ...
	                <?php if ( $enable_prevent === 'yes' ) { ?>
		                <div class="edgtf-sp-prevent">
			                <div class="edgtf-sp-prevent-inner">
				                ...
				                <label class="edgtf-sp-prevent-label"><?php esc_html_e( 'Prevent This Pop-up', 'overworld' ); ?></label>
			                </div>
		                </div>
	                <?php } ?>
                </div>
