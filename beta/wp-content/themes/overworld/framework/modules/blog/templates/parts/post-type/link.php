...
if(overworld_edge_get_blog_module() == 'list') {
...
<div class="edgtf-post-link-holder">
    ...
    <?php if(!empty($post_link_meta)) { ?>
        <h6 class="edgtf-post-link-url">
            <a target="_blank" href="<?php echo esc_url($post_link_meta) ?>"><?php echo esc_html($post_link_meta) ?></a>
        </h6>
    <?php } ?>
</div>