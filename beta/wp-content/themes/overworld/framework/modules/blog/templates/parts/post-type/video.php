    ...
    if ( $video_type == 'social_networks' ) {
	    ...
	    <div class="edgtf-self-hosted-video-holder">
		    <div class="edgtf-video-wrap">
			    <video class="edgtf-self-hosted-video" poster="<?php echo esc_attr( $videoimage ); ?>" preload="auto">
				    ...
				    <object width="320" height="240" type="application/x-shockwave-flash" data="<?php echo esc_attr( $flashmedia ); ?>">
					    ...
					    <img itemprop="image" src="<?php echo esc_attr( $videoimage ); ?>" width="1920" height="800" title="<?php esc_attr_e( 'No video playback capabilities', 'overworld' ); ?>" alt="<?php esc_attr_e( 'Video Thumb', 'overworld' ); ?>"/>
				    </object>
			    </video>
		    </div>
	    </div>
