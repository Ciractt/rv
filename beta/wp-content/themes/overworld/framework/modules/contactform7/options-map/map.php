...
if ( ! function_exists('overworld_edge_contact_form_7_options_map') ) {

	function overworld_edge_contact_form_7_options_map() {
		
		overworld_edge_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'overworld' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = overworld_edge_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'overworld' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = overworld_edge_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'overworld' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'overworld' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = overworld_edge_add_admin_row(
			array(
		...
		overworld_edge_add_admin_field(array(
			...
			'default_value' => '',
			'label'         => esc_html__( 'Placeholder Text Color', 'overworld' ),
		));
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'overworld' ),
			)
		);
		...
		$typography_text_row2 = overworld_edge_add_admin_row(
			array(
		...
		$typography_text_row3 = overworld_edge_add_admin_row(
			array(
		...
		$typography_label_group = overworld_edge_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'overworld' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'overworld' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = overworld_edge_add_admin_row(
			array(
		...
		$typography_label_row2 = overworld_edge_add_admin_row(
			array(
		...
		$background_border_group = overworld_edge_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'overworld' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'overworld' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = overworld_edge_add_admin_row(
			array(
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'overworld' )
			)
		);
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'overworld' )
			)
		);
		
		$background_border_row2 = overworld_edge_add_admin_row(
			array(
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'overworld' ),
			)
		);
		...
		overworld_edge_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'overworld' )
			)
		);
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'overworld' )
			)
		);
		
		$background_border_row3 = overworld_edge_add_admin_row(
			array(
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'overworld' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = overworld_edge_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'overworld' ),
				'description' => 'Setup form elements padding',
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = overworld_edge_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'overworld' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'overworld' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'overworld' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'overworld' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = overworld_edge_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'overworld' ),
				'description' => esc_html__( 'Setup form elements margin', 'overworld' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = overworld_edge_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top', 'overworld' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom', 'overworld' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'overworld' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'overworld' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = overworld_edge_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'overworld' ),
				'description' => esc_html__( 'Setup button text typography', 'overworld' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = overworld_edge_add_admin_row(
			array(
		...
		$button_typography_row2 = overworld_edge_add_admin_row(
			array(
		...
		$button_background_border_group = overworld_edge_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'overworld' ),
				'description' => esc_html__( 'Setup button background and border style', 'overworld' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = overworld_edge_add_admin_row(
			array(
		...
		overworld_edge_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'overworld' )
			)
		);
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'overworld' )
			)
		);
		
		$button_background_border_row2 = overworld_edge_add_admin_row(
			array(
		...
		overworld_edge_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'overworld' )
			)
		);
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'overworld' )
			)
		);
		
		$button_background_border_row3 = overworld_edge_add_admin_row(
			array(
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'overworld' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		overworld_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'overworld' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = overworld_edge_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'overworld')
		));

		//Text Typography

		$typography_text_group = overworld_edge_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'overworld'),
			'description'	=> esc_html__('Setup typography for form elements text', 'overworld'),
		...
		$typography_text_row1 = overworld_edge_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = overworld_edge_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = overworld_edge_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = overworld_edge_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'overworld'),
			'description'	=> esc_html__('Setup typography for form elements label', 'overworld'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = overworld_edge_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = overworld_edge_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = overworld_edge_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'overworld'),
			'description'	=> esc_html__('Setup form elements background and border style', 'overworld'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = overworld_edge_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = overworld_edge_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = overworld_edge_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = overworld_edge_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'overworld'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = overworld_edge_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = overworld_edge_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'overworld'),
			'description'	=> esc_html__('Setup form elements margin', 'overworld'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = overworld_edge_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = overworld_edge_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'overworld'),
			'description'	=> esc_html__('Setup button text typography', 'overworld'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = overworld_edge_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = overworld_edge_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = overworld_edge_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'overworld'),
			'description'	=> esc_html__('Setup button background and border style', 'overworld'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = overworld_edge_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = overworld_edge_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = overworld_edge_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = overworld_edge_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'overworld')
        ));
        ...
        $typography_label_row3 = overworld_edge_add_admin_row(array(
        ...
        $button_typography_row3 = overworld_edge_add_admin_row(array(
	...
	add_action( 'overworld_edge_action_options_map', 'overworld_edge_contact_form_7_options_map', overworld_edge_set_options_map_position( 'contact_form_7' ) );
}