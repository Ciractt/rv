...
if ( class_exists( 'OverworldCoreClassWidget' ) ) {
	class OverworldEdgeClassContactForm7Widget extends OverworldCoreClassWidget {
		public function __construct() {
			parent::__construct(
				'edgtf_contact_form_7_widget',
				esc_html__( 'Overworld Contact Form 7 Widget', 'overworld' ),
				array( 'description' => esc_html__( 'Add contact form 7 to widget areas', 'overworld' ) )
			);
		...
		protected function setParams() {
			...
			$this->params = array(
				array(
					'type'  => 'textfield',
					'name'  => 'extra_class',
					'title' => esc_html__( 'Extra Class Name', 'overworld' )
				),
				array(
					'type'  => 'textfield',
				...
				array(
					'type'    => 'dropdown',
					'name'    => 'contact_form',
					'title'   => esc_html__( 'Select Contact Form 7', 'overworld' ),
					'options' => $contact_forms
				),
				array(
					'type'    => 'dropdown',
					'name'    => 'contact_form_style',
					'title'   => esc_html__( 'Contact Form 7 Style', 'overworld' ),
					'options' => array(
		...
		public function widget( $args, $instance ) {
			...
			?>
			<div class="widget edgtf-contact-form-7-widget <?php echo esc_attr( $extra_class ); ?>" <?php echo overworld_edge_get_inline_style( $widget_styles ); ?>>
