			...
			$.each(items, function (key, value) {
				...
				if (optionName === key) {
					...
					switch (otherOptionType) {
						case 'checkbox':
							otherValue = $('.edgtf-dependency-option[data-option-name="' + key + '"]').find('input[type="hidden"][name="' + key + '"]').val();
							break;
						case 'selectbox':
							otherValue = $('.edgtf-dependency-option[data-option-name="' + key + '"]').val();
							break;
					}
