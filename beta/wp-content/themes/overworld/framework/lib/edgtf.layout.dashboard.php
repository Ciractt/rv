...
/*
   Class: OverworldEdgeClassDashboardForm
   A class that initializes Edge Dashboard Container
*/

class OverworldEdgeClassDashboardForm implements iOverworldEdgeInterfaceLayoutNode, iOverworldEdgeInterfaceRender {
	public $children;
	public $name;
	public $form_id;
	public $form_method;
	...
	public function render( $factory ) {
		...
		<form method="<?php echo esc_attr( $this->form_method ); ?>" id="<?php echo esc_attr( $this->form_id ); ?>" class="<?php echo esc_attr( $action_class ) ?>" data-action="<?php echo esc_attr( $this->form_action ); ?>">
			...
			if ( overworld_edge_is_plugin_installed( 'core' ) ) {
				echo overworld_edge_get_button_html( array(
					'html_type'    => 'button',
					'custom_class' => 'edgtf-dashboard-form-button',
...
/*
   Class: OverworldEdgeClassDashboardGroup
   A class that initializes OverworldEdgeClass Group Field
*/
class OverworldEdgeClassDashboardGroup implements iOverworldEdgeInterfaceLayoutNode, iOverworldEdgeInterfaceRender {
	public $children;
	public $name;
	public $title;
	public $description;
...
/*
   Class: OverworldEdgeClassDashboardTitle
   A class that initializes Dashboard Title
*/
class OverworldEdgeClassDashboardTitle implements iOverworldEdgeInterfaceRender {
	private $name;
	private $title;
	private $args = array();
	...
	public function render( $factory ) {
		...
		?>
		<h5 class="edgtf-dashboard-section-subtitle <?php echo esc_attr( $class ); ?>" id="edgtf_<?php echo esc_attr( $this->name ); ?>"><?php echo esc_html( $this->title ); ?></h5>
		<?php
	}
}

/*
   Class: OverworldEdgeClassDashboardField
   A class that initializes OverworldEdgeClass Front Field
*/
class OverworldEdgeClassDashboardField implements iOverworldEdgeInterfaceRender {
	private $type;
	private $name;
	private $label;
	private $description;
...
abstract class OverworldEdgeClassDashboardFieldType {
	abstract public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = "" );
}

class OverworldEdgeClassDashboardFieldText extends OverworldEdgeClassDashboardFieldType {
			...
			<div class="edgtf-dashboard-field-row">
				<div class="edgtf-dashboard-item col-lg-<?php echo esc_attr( $col_width ); ?>">
					<div class="edgtf-dashboard-input-holder">
						...
						<input class="edgtf-dashboard-input" type="<?php echo esc_attr( $input_type ); ?>" name="<?php echo esc_attr( $name ); ?>" id="<?php echo esc_attr( $id ); ?>" value="<?php echo esc_attr( htmlspecialchars( $value ) ); ?>">
						<?php if ( $description !== '' ) { ?>
...
class OverworldEdgeClassDashboardFieldTextArea extends OverworldEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class OverworldEdgeClassDashboardFieldImage extends OverworldEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
			...
			<div class="edgtf-dashboard-gallery-holder">
				<ul class="edgtf-dashboard-gallery-images-holder">
					<?php if ( isset( $value_html ) ) {
						echo overworld_edge_get_module_part( $value_html );
					} ?>
				</ul>
				<div class="edgtf-dashboard-gallery-uploader">
					<?php
					if ( overworld_membership_theme_installed() ) {
						echo overworld_edge_get_button_html( array(
							'text'         => esc_html__( 'Upload', 'overworld' ),
							'custom_class' => 'edgtf-dashboard-gallery-upload'
						) );
					} else {
						echo '<a itemprop="url" href="#" class="edgtf-btn edgtf-btn-medium edgtf-btn-solid edgtf-dashboard-gallery-upload"><span class="edgtf-btn-text">' . esc_html__( 'Upload', 'overworld' ) . '</span></a>';
					} ?>
					<input class="edgtf-dashboard-gallery-upload-hidden" type="file" name="<?php echo esc_attr( $name ); ?>" id="<?php echo esc_attr( $name ); ?>" value="">
					...
					<?php if ( $value !== '' && $value !== false ) { ?>
						<button class="edgtf-btn edgtf-btn-solid edgtf-dashboard-remove-image"><?php esc_html_e( 'Remove Media', 'overworld' ); ?></button>
					<?php } ?>
				</div>
			</div>
		</div>
...
class OverworldEdgeClassDashboardFieldGallery extends OverworldEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
		...
		<div class="edgtf-dashboard-field-holder <?php echo esc_attr( $class ); ?>">
			...
			<div class="edgtf-dashboard-gallery-holder">
				...
				<div class="edgtf-dashboard-gallery-uploader">
					...
					<input class="edgtf-dashboard-gallery-upload-hidden" type="file" name="<?php echo esc_attr( $name ); ?>" id="<?php echo esc_attr( $name ); ?>" value="" multiple>
					<input type="hidden" class="edgtf-dashboard-media-hidden" name="<?php echo esc_attr( $hidden_name ); ?>" value="<?php echo esc_attr( $value ); ?>"/>
					<?php if ( $value !== '' ) { ?>
						<button class="edgtf-btn edgtf-btn-solid edgtf-dashboard-remove-image"><?php esc_html_e( 'Remove Media', 'overworld' ); ?></button>
					<?php } ?>
...
class OverworldEdgeClassDashboardFieldSelect extends OverworldEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
...
class OverworldEdgeClassDashboardFieldDate extends OverworldEdgeClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		if ( ! empty( $repeat ) && array_key_exists( 'name', $repeat ) && array_key_exists( 'index', $repeat ) ) {
			$id   = $name . '-' . $repeat['index'];
			$name = $repeat['name'] . '[' . $repeat['index'] . '][' . $name . ']';
...
class OverworldEdgeClassDashboardFieldIcon extends OverworldEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$options           = overworld_edge_icon_collections()->getIconCollectionsEmpty();
		$icons_collections = overworld_edge_icon_collections()->getIconCollectionsKeys();
				...
				<div class="edgtf-dashboard-item">
					...
					<div class="edgtf-dashboard-icon-holder">
						...
						<?php foreach ( $icons_collections as $icons_collection ) {
							$icons_param = overworld_edge_icon_collections()->getIconCollectionParamNameByKey( $icons_collection );
							$field_class = ! empty( $value ) && $value['icon_pack'] == $icons_collection ? 'edgtf-show-field' : 'edgtf-hide-field';
							?>
							<div class="edgtf-icon-collection-holder <?php echo esc_attr( $field_class ); ?>" data-icon-collection="<?php echo esc_attr( $icons_collection ); ?>">
								<select name="<?php echo esc_attr( $name . '[' . $icons_param . ']' ); ?>" id="<?php echo esc_attr( $name . '[' . $icons_param . ']' ); ?>">
									<?php
									$icons       = overworld_edge_icon_collections()->getIconCollection( $icons_collection );
...
class OverworldEdgeClassDashboardFieldColor extends OverworldEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		if ( ! empty( $repeat ) && array_key_exists( 'name', $repeat ) && array_key_exists( 'index', $repeat ) ) {
			$id   = $name . '-' . $repeat['index'];
			$name = $repeat['name'] . '[' . $repeat['index'] . '][' . $name . ']';
		...
		<div class="edgtf-dashboard-field-holder <?php echo esc_attr( $class ); ?>">
			<div class="edgtf-dashboard-field-row">
				<div class="edgtf-dashboard-item">
					<div class="edgtf-dashboard-input-holder">
						<label for="<?php echo esc_attr( $name ); ?>"><?php echo esc_html( $label ); ?></label>
						<input class="edgtf-dashboard-color-field" type="text" name="<?php echo esc_attr( $name ); ?>" id="<?php echo esc_attr( $id ); ?>" value="<?php echo esc_attr( htmlspecialchars( $value ) ); ?>">
						<?php if ( $description !== '' ) { ?>
							<p class="description"><?php echo esc_html( $description ); ?></p>
						<?php } ?>
					</div>
...
class OverworldEdgeClassDashboardFieldCheckBoxGroup extends OverworldEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
							...
							<?php foreach ( $options as $option_key => $option_label ) {
								...
								<div class="col-lg-3">
									<label class="edgtf-checkbox-label" for="<?php echo esc_attr( $name . '_' . $option_key ) . '-' . $i; ?>">
										...
										<span class="edgtf-label-text"><?php echo esc_html( $option_label ); ?></span>
									</label>
								</div>
								<?php
								$i ++;
...
class OverworldEdgeClassDashboardFieldAddress extends OverworldEdgeClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
		if ( isset( $args["col_width"] ) ) {
			$col_width = $args["col_width"];
			...
			<div class="edgtf-dashboard-field-row">
				<div class="edgtf-dashboard-item col-lg-<?php echo esc_attr( $col_width ); ?>">
					<div class="edgtf-dashboard-input-holder">
						...
						<a class="edgtf-reset-marker edgtf-hide-field" href="#"><?php esc_html_e( 'Reset Marker', 'overworld' ); ?></a>
...
class OverworldEdgeClassDashboardRepeater implements iOverworldEdgeInterfaceRender {
	private $label;
	private $description;
	private $name;
	private $fields;
	...
	function __construct( $fields, $name, $label = '', $description = '', $button_text = '', $table_layout = false, $value = array() ) {
		...
		$this->name         = $name;
		$this->num_of_rows  = 1;
		$this->button_text  = ! empty( $button_text ) ? $button_text : esc_html__( 'Add New Item', 'overworld' );
			...
			<?php if ( $this->table_layout ) { ?>
				<div class="edgtf-dashboard-repeater-table-heading">
					<div class="edgtf-dashboard-repeater-fields-holder">
						<div class="edgtf-dashboard-repeater-table-cell edgtf-dashboard-repeater-sort"><?php esc_html_e( 'Order', 'overworld' ) ?></div>
						...
						<div class="edgtf-dashboard-repeater-table-cell edgtf-dashboard-repeater-remove"><?php esc_html_e( 'Remove', 'overworld' ) ?></div>
					</div>
				</div>
			<?php } ?>
...
class OverworldEdgeClassDashboardFieldFactory {
	public function render( $field_type, $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		switch ( strtolower( $field_type ) ) {
			case 'text':
				$field = new OverworldEdgeClassDashboardFieldText();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'textarea':
				$field = new OverworldEdgeClassDashboardFieldTextArea();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'date':
				$field = new OverworldEdgeClassDashboardFieldDate();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'image':
				$field = new OverworldEdgeClassDashboardFieldImage();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'gallery':
				$field = new OverworldEdgeClassDashboardFieldGallery();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'select':
				$field = new OverworldEdgeClassDashboardFieldSelect();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'icon':
				$field = new OverworldEdgeClassDashboardFieldIcon();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'color':
				$field = new OverworldEdgeClassDashboardFieldColor();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'checkboxgroup':
				$field = new OverworldEdgeClassDashboardFieldCheckBoxGroup();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'address':
				$field = new OverworldEdgeClassDashboardFieldAddress();
