...
if ( ! function_exists( 'overworld_edge_add_ion_icon_pack' ) ) {
	function overworld_edge_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new OverworldEdgeClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'overworld_edge_filter_add_icon_pack_into_collection', 'overworld_edge_add_ion_icon_pack' );
}

if ( ! function_exists( 'overworld_edge_add_ion_icon_pack_option' ) ) {
	function overworld_edge_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'overworld' );
		
		return $options;
	}
	
	add_filter( 'overworld_edge_filter_add_icon_pack_into_options', 'overworld_edge_add_ion_icon_pack_option' );
	add_filter( 'overworld_edge_filter_add_icon_pack_into_social_options', 'overworld_edge_add_ion_icon_pack_option' );
}

class OverworldEdgeClassIonIcons implements iOverworldEdgeInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = OVERWORLD_EDGE_FRAMEWORK_ICONS_ROOT . '/ion-icons/css/ionicons.min.css';
	}
	...
	public function getBackToTopIcon() {
		...
		return $this->render('ion-android-arrow-up');
	}
