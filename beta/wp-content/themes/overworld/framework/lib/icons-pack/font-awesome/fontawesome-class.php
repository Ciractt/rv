...
if ( ! function_exists( 'overworld_edge_add_font_awesome_icon_pack' ) ) {
	function overworld_edge_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new OverworldEdgeClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'overworld_edge_filter_add_icon_pack_into_collection', 'overworld_edge_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'overworld_edge_add_font_awesome_icon_pack_option' ) ) {
	function overworld_edge_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'overworld' );
		
		return $options;
	}
	
	add_filter( 'overworld_edge_filter_add_icon_pack_into_options', 'overworld_edge_add_font_awesome_icon_pack_option' );
	add_filter( 'overworld_edge_filter_add_icon_pack_into_social_options', 'overworld_edge_add_font_awesome_icon_pack_option' );
}

class OverworldEdgeClassIconsFontAwesome implements iOverworldEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = OVERWORLD_EDGE_FRAMEWORK_ICONS_ROOT . '/font-awesome/css/fontawesome-all.min.css';
	}
	...
	private function getNewIconsArray( $brandsIcons = false ) {
		...
		$iconsArray = array();
		$icons      = json_decode( $wp_filesystem->get_contents( OVERWORLD_EDGE_FRAMEWORK_ICONS_ROOT_DIR . '/font-awesome/icons.json' ) );
