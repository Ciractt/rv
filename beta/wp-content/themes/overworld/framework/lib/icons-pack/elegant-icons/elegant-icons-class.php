...
if ( ! function_exists( 'overworld_edge_add_font_elegant_icon_pack' ) ) {
	function overworld_edge_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new OverworldEdgeClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'overworld_edge_filter_add_icon_pack_into_collection', 'overworld_edge_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'overworld_edge_add_font_elegant_icon_pack_option' ) ) {
	function overworld_edge_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'overworld' );
		
		return $options;
	}
	
	add_filter( 'overworld_edge_filter_add_icon_pack_into_options', 'overworld_edge_add_font_elegant_icon_pack_option' );
	add_filter( 'overworld_edge_filter_add_icon_pack_into_social_options', 'overworld_edge_add_font_elegant_icon_pack_option' );
}

class OverworldEdgeClassIconsFontElegant implements iOverworldEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = OVERWORLD_EDGE_FRAMEWORK_ICONS_ROOT . '/elegant-icons/style.min.css';
	}
