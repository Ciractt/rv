...
if ( ! function_exists( 'overworld_edge_add_linear_icon_pack' ) ) {
	function overworld_edge_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new OverworldEdgeClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'overworld_edge_filter_add_icon_pack_into_collection', 'overworld_edge_add_linear_icon_pack' );
}

if ( ! function_exists( 'overworld_edge_add_linear_icon_pack_option' ) ) {
	function overworld_edge_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'overworld' );
		
		return $options;
	}
	
	add_filter( 'overworld_edge_filter_add_icon_pack_into_options', 'overworld_edge_add_linear_icon_pack_option' );
}

class OverworldEdgeClassLinearIcons implements iOverworldEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = OVERWORLD_EDGE_FRAMEWORK_ICONS_ROOT . '/linear-icons/style.css';
	}
