...
if ( ! function_exists( 'overworld_edge_add_dripicons_icon_pack' ) ) {
	function overworld_edge_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new OverworldEdgeClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'overworld_edge_filter_add_icon_pack_into_collection', 'overworld_edge_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'overworld_edge_add_dripicons_icon_pack_option' ) ) {
	function overworld_edge_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'overworld' );
		
		return $options;
	}
	
	add_filter( 'overworld_edge_filter_add_icon_pack_into_options', 'overworld_edge_add_dripicons_icon_pack_option' );
}

class OverworldEdgeClassDripicons implements iOverworldEdgeInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->param = $param;
        $this->setIconsArray();
        $this->styleUrl = OVERWORLD_EDGE_FRAMEWORK_ICONS_ROOT . '/dripicons/dripicons.css';
    }
