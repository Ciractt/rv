...
if ( ! function_exists( 'overworld_edge_add_simple_line_icon_pack' ) ) {
	function overworld_edge_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new OverworldEdgeClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'overworld_edge_filter_add_icon_pack_into_collection', 'overworld_edge_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'overworld_edge_add_simple_line_icon_pack_option' ) ) {
	function overworld_edge_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'overworld' );
		
		return $options;
	}
	
	add_filter( 'overworld_edge_filter_add_icon_pack_into_options', 'overworld_edge_add_simple_line_icon_pack_option' );
	add_filter( 'overworld_edge_filter_add_icon_pack_into_social_options', 'overworld_edge_add_simple_line_icon_pack_option' );
}

class OverworldEdgeClassSimpleLineIcons implements iOverworldEdgeInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->styleUrl = OVERWORLD_EDGE_FRAMEWORK_ICONS_ROOT . '/simple-line-icons/simple-line-icons.css';
    }
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'overworld'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'overworld'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'overworld'),
            'icon-social-facebook'    => esc_html__('Facebook', 'overworld'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'overworld'),
            'icon-social-github'      => esc_html__('Github', 'overworld'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'overworld'),
            'icon-social-instagram'   => esc_html__('Instagram', 'overworld'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'overworld'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'overworld'),
            'icon-social-reddit'      => esc_html__('Reddit', 'overworld'),
            'icon-social-skype'       => esc_html__('Skype', 'overworld'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'overworld'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'overworld'),
            'icon-social-spotify'     => esc_html__('Spotify', 'overworld'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'overworld'),
            'icon-social-twitter'     => esc_html__('Twitter', 'overworld'),
            'icon-social-youtube'     => esc_html__('Youtube', 'overworld')
        );
    }
